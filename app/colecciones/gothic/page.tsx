...
export default function GothicCollectionPage() {
  return (
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div className="py-8 lg:py-16">
              ...
              >
                <CrossIcon className="h-6 w-6 text-foreground" />
              ...
              >
                Oscuridad, actitud y diseño premium. La colección que definió el estilo MIRR con tipografía gótica y gráficos únicos.
              </motion.p>
...
function CrossIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="currentColor">
      <path d="M12 2L12 22M2 12L22 12" stroke="currentColor" strokeWidth="2" fill="none" />
      <path d="M12 5L12 19M5 12L19 12" stroke="currentColor" strokeWidth="1" fill="none" />
    </svg>
  )
}
